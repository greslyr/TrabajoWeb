...
<html lang="es">
    ...
    <body class="bodyiniciar">
        <div class="container">
            ...
            <form class="formularioInicio" action="">
                <input type="email" name=correo placeholder="Correo" required class="inputsesion">
                <input type="password" placeholder="Contraseña" name="contrasena" required class="inputsesion">
                <a href="#" class="forgot-password">Olvidé mi contraseña</a>
                <input type="submit" class="btnIngresar" value="INGRESAR">
            </form>
